...
export default async function handler(req,res){
  ...
  try{
    ...
    return send(res,200,{...data,_meta:{model:r.model,usage:r.usage,referencesAnalyzed:imgs.length,promptLimit:VIDEO_PROMPT_MAX_CHARS,promptChars:fit.finalChars,promptOriginalChars:fit.originalChars,promptCompacted:fit.compacted,promptCompaction:fit.method}});
