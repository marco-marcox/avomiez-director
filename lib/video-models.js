export const MODEL_PROFILES_VERIFIED_AT='2026-08-29';
...
export const VIDEO_MODELS={
  ...
  'pixverse-v6':{
    ...
    bestFor:'1–15s 1080p clips, native multi-shot/audio, Fusion reference-to-video, transition and extension workflows.',
    strategy:'Structure the prompt around Subject + Environment + Action + Camera + Lighting + Sound + Format. For Omni/Fusion, map image/video references explicitly and keep video-reference intent focused on subject/action/scene/camera/style.'
  },
  'happyhorse-1.1':{
