(()=>{
  ...
  window.AVOMIEZ_UI_VERSION='V2.7';
  document.title='AvoMiez Director V2.7';
  ...
  function panel(scope,title,subtitle){
    ...
    wrap.innerHTML=`<div style="margin-top:12px;padding:10px;border:1px solid #58401f;border-radius:13px;background:linear-gradient(180deg,#171109,#0d1119)">
      <div class="analysisBadge" style="background:#241a0d;color:#ffd98a">V2.7 TONE OVERLAY</div>
  ...
  function refresh(){
    installPanels();
    const h=$('.top h1');if(h&&h.textContent!=='AvoMiez Director V2.7')h.textContent='AvoMiez Director V2.7';
  ...
  refresh();
  console.log('AvoMiez Director V2.7 universal tone overlay ready');
})();
